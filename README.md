...
A full-stack, web-based management platform designed to streamline operations for shared workspaces. This system provides a seamless experience for members to book resources and for administrators to manage daily operations.

🚀 Key Features
Real-Time Desk & Room Booking: Utilizes an interactive interface for members to reserve workspace resources based on live availability.
...
Admin Dashboard: A centralized control center for monitoring occupancy rates, managing active bookings, and viewing usage analytics.
...
Update Connection String: Modify the appsettings.json file to point to your local SQL Server instance.

Apply Migrations: Run Update-Database in the Package Manager Console to create the SQL schema.

Run: Press F5 in Visual Studio to launch the application.
